...
class ResultActivity : AppCompatActivity() {
    ...
    private fun calculate() {
        ...
        tvEthanolAverageResult.text = (ethanolPrice / ethanolAverage).format(2).toString()
        tvGasAverageResult.text = (gasPrice / gasAverage).format(2).toString()
        tvFuelRatio.text = getString(R.string.label_fuel_ratio, performanceOfMyCar.format(2).toString())
    }
